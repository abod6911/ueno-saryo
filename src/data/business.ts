...
export const BUSINESS_DATA: BusinessInfo = {
  ...
  descriptionZh:
    '坐落于吉达 Ar Rawdah 核心区的日式茶室圣所，致力于以纯正严谨的茶道仪式、精确的水温矿物配比，呈现石臼研磨顶级仪式抹茶与日本原叶名茶。',
  address: {
    streetEn: '7140 Prince Saud Al Faisal',
    streetAr: '٧١٤٠ طريق الأمير سعود الفيصل',
    streetZh: '萨欧德·费萨尔王子路 7140 号',
    districtEn: 'Ar Rawdah',
    districtAr: 'حي الروضة',
    districtZh: 'Ar Rawdah 区',
    cityEn: 'Jeddah',
    cityAr: 'جدة',
    cityZh: '吉达',
    postalCode: '23432',
  ...
  instagramUrl: 'https://www.instagram.com/ueno_saryo/',
  tiktokUrl: 'https://www.tiktok.com/@uenosaryotea',
  openingHours: [
    { dayEn: 'Saturday', dayAr: 'السبت', dayZh: '星期六', opens: '08:00', closes: '23:30' },
    { dayEn: 'Sunday', dayAr: 'الأحد', dayZh: '星期日', opens: '08:00', closes: '23:30' },
    { dayEn: 'Monday', dayAr: 'الإثنين', dayZh: '星期一', opens: '08:00', closes: '23:30' },
    { dayEn: 'Tuesday', dayAr: 'الثلاثاء', dayZh: '星期二', opens: '08:00', closes: '23:30' },
    { dayEn: 'Wednesday', dayAr: 'الأربعاء', dayZh: '星期三', opens: '08:00', closes: '23:30' },
    { dayEn: 'Thursday', dayAr: 'الخميس', dayZh: '星期四', opens: '08:00', closes: '00:00' },
    { dayEn: 'Friday', dayAr: 'الجمعة', dayZh: '星期五', opens: '13:30', closes: '00:30' },
  ],
  rating: {
    score: 4.2,
    reviewCount: 561,
