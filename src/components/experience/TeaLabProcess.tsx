...
export const TeaLabProcess: React.FC = () => {
  ...
  return (
    <section id="tea-experience" className="w-full bg-[#19321d] text-[#f8f7f1] py-20 sm:py-32 relative overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-[1720px] mx-auto px-4 sm:px-8 lg:px-14 relative z-10">
          ...
          {TEA_LAB_STEPS.map((step, idx) => {
            ...
            return (
              <button
                ...
                className={`min-h-[70px] sm:min-h-[85px] p-4 rounded-2xl flex flex-col justify-between text-start transition-all duration-300 active:scale-95 border ${
                  isActive
                    ? 'bg-[#f0ede1] text-[#122416] shadow-card border-transparent ring-2 ring-white/20'
                    : 'bg-[#122416]/60 hover:bg-[#122416] text-white/80 border-white/10'
                }`}
              >
        ...
        <div className="w-full bg-[#122416] rounded-3xl p-6 sm:p-10 lg:p-14 border border-white/12 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12">
          ...
          <div className="flex-1 flex flex-col items-start gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-japanese text-xs text-[#939458] tracking-wider uppercase">
                  {activeStep.nameJa}
                </span>
            ...
            <div className="w-full p-4 rounded-2xl bg-white/5 border border-white/10 text-xs text-[#939458] flex items-start gap-3 mt-2">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center gap-2 text-xs font-semibold text-[#939458] hover:text-white transition-colors"
            >
          ...
          {/* Right: Step Visual Photo */}
          <div className="w-full lg:w-[460px] aspect-[4/3] rounded-2xl border border-white/15 overflow-hidden relative shadow-2xl shrink-0 group">
            <img
