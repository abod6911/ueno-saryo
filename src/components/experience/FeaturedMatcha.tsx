...
export const FeaturedMatcha: React.FC = () => {
  ...
  return (
    <section id="matcha-studied" className="w-full bg-[#122416] text-[#f8f7f1] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#29482a]/25 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6">
            ...
            <div className="flex flex-col">
              <span className="font-japanese text-xs sm:text-sm text-[#939458] tracking-widest uppercase mb-1 font-medium">
                茶道研究所 · 宇治抹茶
              </span>
          ...
          {/* Right Column: Visual Stage Showcase with Organic Motif Crop */}
          <div className="lg:col-span-6 relative flex items-center justify-center">
            ...
            <div className="relative w-full aspect-[4/3] max-w-[540px] matcha-organic-crop bg-[#19321d] border border-white/15 overflow-hidden shadow-2xl group">
              ...
              <div className="absolute top-5 start-5 z-20 bg-black/60 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/15 text-[11px] text-[#f8f7f1] font-mono shadow-sm">
                Stone-ground Uji Tencha
              </div>

              <div className="absolute bottom-5 end-5 z-20 bg-[#EFEDE3] text-[#122416] px-4 py-2 rounded-2xl font-bold text-xs shadow-lg">
